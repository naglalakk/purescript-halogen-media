...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Halogen.Media.Data.Image"] = $PS["Halogen.Media.Data.Image"] || {};
  var exports = $PS["Halogen.Media.Data.Image"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  var Data_Generic_Rep_Show = $PS["Data.Generic.Rep.Show"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Show = $PS["Data.Show"];
  var Data_Symbol = $PS["Data.Symbol"];
  var genericImage = new Data_Generic_Rep.Generic(function (x) {
      return x;
  }, function (x) {
      return x;
  });
  var showImage = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericImage)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "id";
      ...
      return "thumbnail";
  }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Show.showString))(Data_Show.showString))(Data_Show.showInt))))(new Data_Symbol.IsSymbol(function () {
      return "Image";
  }))));
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Halogen.Media.Data.Video"] = $PS["Halogen.Media.Data.Video"] || {};
  var exports = $PS["Halogen.Media.Data.Video"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  var Data_Generic_Rep_Show = $PS["Data.Generic.Rep.Show"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Show = $PS["Data.Show"];
  var Data_Symbol = $PS["Data.Symbol"];
  var genericVideo = new Data_Generic_Rep.Generic(function (x) {
      return x;
  }, function (x) {
      return x;
  });
  var showVideo = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericVideo)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "id";
  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "src";
  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      ...
      return "title";
  }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Show.showString))(Data_Show.showInt))))(new Data_Symbol.IsSymbol(function () {
      return "Video";
  }))));
  exports["genericVideo"] = genericVideo;
  exports["showVideo"] = showVideo;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Halogen.Media.Data.Base"] = $PS["Halogen.Media.Data.Base"] || {};
  var exports = $PS["Halogen.Media.Data.Base"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  var Data_Generic_Rep_Show = $PS["Data.Generic.Rep.Show"];
  var Data_Show = $PS["Data.Show"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Halogen_Media_Data_Image = $PS["Halogen.Media.Data.Image"];
  var Halogen_Media_Data_Video = $PS["Halogen.Media.Data.Video"];                
  var MediaImage = (function () {
      function MediaImage(value0) {
          this.value0 = value0;
      };
      MediaImage.create = function (value0) {
          return new MediaImage(value0);
      };
      return MediaImage;
  })();
  var MediaVideo = (function () {
      function MediaVideo(value0) {
          this.value0 = value0;
      };
      MediaVideo.create = function (value0) {
          return new MediaVideo(value0);
      };
      return MediaVideo;
  })();
  var genericMedia = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Halogen.Media.Data.Base (line 16, column 1 - line 16, column 48): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new MediaImage(x.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr) {
          return new MediaVideo(x.value0);
      };
      throw new Error("Failed pattern match at Halogen.Media.Data.Base (line 16, column 1 - line 16, column 48): " + [ x.constructor.name ]);
  });
  var showMedia = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericMedia)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Halogen_Media_Data_Image.showImage))(new Data_Symbol.IsSymbol(function () {
      return "MediaImage";
  })))(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Halogen_Media_Data_Video.showVideo))(new Data_Symbol.IsSymbol(function () {
      return "MediaVideo";
  })))));
  exports["MediaImage"] = MediaImage;
  exports["MediaVideo"] = MediaVideo;
  exports["genericMedia"] = genericMedia;
  exports["showMedia"] = showMedia;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Example.TestData"] = $PS["Example.TestData"] || {};
  var exports = $PS["Example.TestData"];
  var Data_Array = $PS["Data.Array"];
  var Data_EuclideanRing = $PS["Data.EuclideanRing"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Halogen_Media_Data_Base = $PS["Halogen.Media.Data.Base"];                
  var videos = function (n) {
      var title = new Data_Maybe.Just("Titanic - Leo Scene");
      var thumbnail = new Data_Maybe.Just("https://picsum.photos/150/150/");
      return Data_Array.replicate(n)({
          id: 0,
  ...
  var medias = function (n) {
      var amount = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(n)(2);
      var mediaImages = Data_Functor.map(Data_Functor.functorArray)(function (x) {
          return new Halogen_Media_Data_Base.MediaImage(x);
      })(images(amount));
      var mediaVideos = Data_Functor.map(Data_Functor.functorArray)(function (x) {
          return new Halogen_Media_Data_Base.MediaVideo(x);
      })(videos(amount));
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(mediaImages)(mediaVideos);
  };
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Halogen.Media.Component.MediaDisplay"] = $PS["Halogen.Media.Component.MediaDisplay"] || {};
  var exports = $PS["Halogen.Media.Component.MediaDisplay"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_Component = $PS["Halogen.Component"];
  ...
  var Halogen_Media_Data_Base = $PS["Halogen.Media.Data.Base"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var ClickedMedia = (function () {
      function ClickedMedia(value0) {
          this.value0 = value0;
      };
      ClickedMedia.create = function (value0) {
          return new ClickedMedia(value0);
      };
      return ClickedMedia;
  })();
  var ClickMedia = (function () {
      function ClickMedia(value0) {
          this.value0 = value0;
      };
      ClickMedia.create = function (value0) {
          return new ClickMedia(value0);
      };
      return ClickMedia;
  })();
  var component = (function () {
      var renderMedia = function (media) {
          return Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("media-item"), Halogen_HTML_Events.onClick(function (v) {
              return Data_Maybe.Just.create(new ClickMedia(media));
          }) ])([ (function () {
              if (media instanceof Halogen_Media_Data_Base.MediaImage) {
                  return Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("thumbnail") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(Data_Maybe.fromMaybe("")(media.value0.thumbnail)) ]) ]);
              };
              if (media instanceof Halogen_Media_Data_Base.MediaVideo) {
                  return Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("thumbnail") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(Data_Maybe.fromMaybe("")(media.value0.thumbnail)) ]) ]);
              };
              throw new Error("Failed pattern match at Halogen.Media.Component.MediaDisplay (line 67, column 9 - line 79, column 14): " + [ media.constructor.name ]);
          })() ]);
      };
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("media") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(state.media)(renderMedia));
      };
      ...
      var handleAction = function (v) {
          return Halogen_Query_HalogenM.raise(new ClickedMedia(v.value0));
      };
  ...
  exports["ClickMedia"] = ClickMedia;
  exports["ClickedMedia"] = ClickedMedia;
...
(function($PS) {
  ...
  var fileListToFiles = function (fl) {
      ...
      throw new Error("Failed pattern match at Halogen.Media.Utils (line 14, column 22 - line 18, column 16): " + [ fl.constructor.name ]);
  };
...
(function($PS) {
  ...
  var showOutput = new Data_Show.Show(function (v) {
      return Data_Show.show(Data_Show.showArray(Data_Show.showString))(Data_Functor.map(Data_Functor.functorArray)(Web_File_File.name)(v.value0));
  });
  var component = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("upload-container") ])([ Halogen_HTML_Elements.div([ Halogen_Media_Component_HTML_Utils.css("dropbox"), Halogen_HTML_Events.onDragOver(function (e) {
          ...
          }) ])([ Halogen_HTML_Core.text("Drop files here") ]) ]);
      };
      var initialState = {
          files: [  ]
      };
      var handleAction = function (v) {
          if (v instanceof SetFiles) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_Event_Event.preventDefault(Web_HTML_Event_DragEvent.toEvent(v.value0))))(function () {
                  var uFiles = Halogen_Media_Utils.fileListToFiles(Web_HTML_Event_DataTransfer.files(Web_HTML_Event_DragEvent.dataTransfer(v.value0)));
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var allFiles = Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.files)(uFiles);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.logShow(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(showOutput)(new UploadFiles(allFiles)))(function () {
                              return Halogen_Query_HalogenM.raise(new UploadFiles(allFiles));
                          });
                      });
                  });
              });
          ...
          if (v instanceof PreventDefault) {
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_Event_Event.preventDefault(v.value0));
          };
          throw new Error("Failed pattern match at Halogen.Media.Component.Upload (line 65, column 18 - line 75, column 39): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Halogen.Media.Component.Browser"] = $PS["Halogen.Media.Component.Browser"] || {};
  var exports = $PS["Halogen.Media.Component.Browser"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Show = $PS["Data.Show"];
  ...
  var Halogen_Media_Component_MediaDisplay = $PS["Halogen.Media.Component.MediaDisplay"];
  ...
  var DisplayTab = (function () {
      ...
      DisplayTab.value = new DisplayTab();
      return DisplayTab;
  })();
  var UploadTab = (function () {
      function UploadTab() {

      };
      UploadTab.value = new UploadTab();
      return UploadTab;
  })();
  ...
  var MDOutput = (function () {
      function MDOutput(value0) {
          this.value0 = value0;
      };
      MDOutput.create = function (value0) {
          return new MDOutput(value0);
      };
      return MDOutput;
  })();
  var ULOutput = (function () {
      function ULOutput(value0) {
          this.value0 = value0;
      };
      ULOutput.create = function (value0) {
          return new ULOutput(value0);
      };
      return ULOutput;
  })();
  var showOutput = new Data_Show.Show(function (v) {
      if (v instanceof Clicked) {
          return Data_Show.show(Halogen_Media_Data_Base.showMedia)(v.value0);
      };
      if (v instanceof Files) {
          return Data_Show.show(Data_Show.showArray(Data_Show.showString))(Data_Functor.map(Data_Functor.functorArray)(Web_File_File.name)(v.value0));
      };
      throw new Error("Failed pattern match at Halogen.Media.Component.Browser (line 57, column 1 - line 59, column 52): " + [ v.constructor.name ]);
  });
  var component = function (dictMonadEffect) {
      var render = function (state) {
          if (state.selectedTab instanceof DisplayTab) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "mediaDisplay";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Halogen_Media_Component_MediaDisplay.component)({
                  media: state.media
              })(function ($24) {
                  return Data_Maybe.Just.create(MDOutput.create($24));
              });
          };
          if (state.selectedTab instanceof UploadTab) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "upload";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Halogen_Media_Component_Upload.component(dictMonadEffect))(Data_Unit.unit)(function ($25) {
                  return Data_Maybe.Just.create(ULOutput.create($25));
              });
          };
          throw new Error("Failed pattern match at Halogen.Media.Component.Browser (line 90, column 5 - line 104, column 30): " + [ state.selectedTab.constructor.name ]);
      };
      var initialState = function (input) {
          return {
              media: input.media,
              selectedTab: (function () {
                  if (input.selectedTab instanceof Data_Maybe.Just) {
                      return input.selectedTab.value0;
                  };
                  if (input.selectedTab instanceof Data_Maybe.Nothing) {
                      return DisplayTab.value;
                  };
                  throw new Error("Failed pattern match at Halogen.Media.Component.Browser (line 76, column 20 - line 78, column 28): " + [ input.selectedTab.constructor.name ]);
              })()
          };
      };
      var handleAction = function (v) {
          if (v instanceof MDOutput) {
              return Halogen_Query_HalogenM.raise(new Clicked(v.value0.value0));
          };
          if (v instanceof ULOutput) {
              return Halogen_Query_HalogenM.raise(new Files(v.value0.value0));
          };
          throw new Error("Failed pattern match at Halogen.Media.Component.Browser (line 81, column 18 - line 85, column 28): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
  ...
  var exports = $PS["Example.Component"];
  var Data_Function = $PS["Data.Function"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Class_Console = $PS["Effect.Class.Console"];
  var Example_TestData = $PS["Example.TestData"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML = $PS["Halogen.HTML"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_Media_Component_Browser = $PS["Halogen.Media.Component.Browser"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var HandleBrowserAction = (function () {
      function HandleBrowserAction(value0) {
          this.value0 = value0;
      };
      HandleBrowserAction.create = function (value0) {
          return new HandleBrowserAction(value0);
      };
  ...
  var component = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "mediaBrowser";
          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Halogen_Media_Component_Browser.component(dictMonadEffect))({
              media: state.media,
              selectedTab: new Data_Maybe.Just(Halogen_Media_Component_Browser.DisplayTab.value)
          })(function ($5) {
              return Data_Maybe.Just.create(HandleBrowserAction.create($5));
          }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "mediaBrowser";
          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Halogen_Media_Component_Browser.component(dictMonadEffect))({
              media: state.media,
              selectedTab: new Data_Maybe.Just(Halogen_Media_Component_Browser.UploadTab.value)
          })(function ($6) {
              return Data_Maybe.Just.create(HandleBrowserAction.create($6));
          }) ]);
      };
      var initialState = {
          media: Example_TestData.medias(20)
      };
      var handleAction = function (v) {
          return Effect_Class_Console.logShow(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Halogen_Media_Component_Browser.showOutput)(v.value0);
      };
      return Halogen_Component.mkComponent({
          initialState: Data_Function["const"](initialState),
          render: render,
  ...
  exports["HandleBrowserAction"] = HandleBrowserAction;
  exports["component"] = component;
})(PS);
(function(exports) {
  "use strict";                                               
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Example_Component.component(Effect_Aff.monadEffectAff))(Data_Unit.unit)(v))(function (v1) {
